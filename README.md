...
- **容量估算**：准备饮品时可选择水、奶茶、咖啡或饮料及默认容量，汇总按每杯准备的容量估算；喝水次数不设上限。
...
当记录需要带饮品信息时，`drinkKind` 可选 `water`、`milkTea`、`coffee`、`beverage`，`volume` 为该杯饮品的毫升数；上厕所和单纯“喝水啦”记录可以传 `null`。旧版没有容量字段的准备饮品记录会按该成员水杯容量估算。
